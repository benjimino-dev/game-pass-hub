...
The primary source of data comes from IGDB, but this third party API does not provide data specific to game son Game Pass, such as the date games were added to Game Pass, the date they are leaving Game Pass and whether or not they are on Game Pass at all.
